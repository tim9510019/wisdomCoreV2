# trainCPTAC_1K.py — AGIV2 持續預訓練終極引擎 (動態 MoE 路由版 + 1.5秒主動式散熱)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/agiv2_cpt_checkpoints_1KS_NV"
LOG_PATH = "~/agiv2_cpt_1KS_NV_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/AGIV2-1B-CPT_GT_NV"
