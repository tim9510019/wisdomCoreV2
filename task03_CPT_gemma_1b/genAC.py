...
def generate_ac_robust(model, tokenizer, prompt_ids, max_gen=64):
    ...
    print("✨ [解碼修正] 關閉自迴歸，啟動全矩陣『單次 Forward 平行拔出』 (Single-Shot Extraction)")
    print("-" * 50)
...
if __name__ == "__main__":
    ...
    true_ans_text = tokenizer.decode([i for i in true_ans_ids if i != tokenizer.pad_token_id], skip_special_tokens=True)
