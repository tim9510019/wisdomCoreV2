# trainRouterAC_GEMMA3_1K_NV.py — 物理隔離對齊終極版 (GEMMA3 架構 + NV 雙卡配置)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/gemma3_zerogate_ac_checkpoints_1K_NV"
LOG_PATH = "~/gemma3_zerogate_ac_1k_nv_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/GEMMA3-1B-Router_1K_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 GEMMA3 Router 第一階訓練矩陣 (純淨架構 1K 版本 + 原生權重起步)...")
    ...
    final_path = os.path.join(SAVE_DIR, "final_gemma3_router_ac.pth")
    torch.save(
        (
            model.state_dict()
