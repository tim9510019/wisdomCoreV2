# trainRouterAC_1KGT_NV.py — 物理隔離對齊終極版 (N -> N+B 範式 + GT 動態 Router + NV 雙卡配置)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/agiv2_zerogate_ac_checkpoints_1KGT_NV"
LOG_PATH = "~/zerogate_32k_ac_1kgt_nv_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/AGIV2-1B-Router_1KGT_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 AGIV2 Router 第一階訓練矩陣 (原生 Gemma 3 權重起步 + 1K GT)...")
