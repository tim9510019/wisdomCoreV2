# trainCPTAC_AGI_GEMMA3_1K_fftrope.py — AGI GEMMA 3 1D Depthwise Conv + Sinc Causal 微調預訓練引擎 (GEMM 全凍結，745,472 可訓練參數，物理隔離)
import os
import sys
import csv
import time
...
# ==========================================
def main():
    print("\n🚀 啟動 GEMMA3 CPT 訓練矩陣 (1D Conv + Sinc Causal 1K 版本，GEMM 全凍結)...")
    ...
    print(f"🟢 可訓練參數總量 (Sinc Causal): {trainable_params:,} (預期應精準等於 745,472)")
