# trainRouterAC_4KGT_NV.py — 物理隔離對齊終極版 (N -> N+B 範式 + GT 動態 Router + NV 雙卡配置)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/agiv2_zerogate_ac_checkpoints_4KGT_NV"
LOG_PATH = "~/zerogate_32k_ac_4kgt_nv_log.csv"
BEST_2K_PATH = "~/agiv2_zerogate_ac_checkpoints_2KGT_NV/best_model.pth"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/AGIV2-1B-Router_4KGT_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 AGIV2 Router 4K 訓練矩陣 (原生 Gemma 3 權重起步 + 4K GT)...")
    ...
    final_path = os.path.join(SAVE_DIR, "final_router_ac_4kgt.pth")
    torch.save(
        (
            model.state_dict()
