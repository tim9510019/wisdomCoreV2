# trainRouterAC_64KGT_NV.py — 物理隔離對齊終極版 (N -> N+B 範式 + GT 動態 Router + NV 雙卡配置)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/agiv2_zerogate_ac_checkpoints_64KGT_NV"
LOG_PATH = "~/zerogate_32k_ac_64kgt_nv_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/AGIV2-1B-Router_64KGT_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 AGIV2 Router 64K 訓練矩陣 (原生 Gemma 3 權重起步 + 64K GT)...")
    ...
    final_path = os.path.join(SAVE_DIR, "final_router_ac_64kgt.pth")
    torch.save(
        (
            model.state_dict()
