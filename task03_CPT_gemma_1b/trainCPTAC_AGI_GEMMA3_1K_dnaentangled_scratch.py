...
SAVE_DIR = "~/agigemma3_scratch_checkpoints_1K_dnaentangled"
LOG_PATH = "~/agigemma3_scratch_1k_dnaentangled_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/AGIGEMMA3-1B-SCRATCH_1K_dnaentangled"
