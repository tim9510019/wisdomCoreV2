# trainRouterAC_GEMMA3_16K_NV.py — 物理隔離對齊終極版 (GEMMA3 架構 + NV 雙卡配置 + 16K 長度)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/gemma3_zerogate_ac_checkpoints_16K_NV"
LOG_PATH = "~/gemma3_zerogate_ac_16k_nv_log.csv"
BEST_8K_PATH = "~/gemma3_zerogate_ac_checkpoints_8K_NV/best_model.pth"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/GEMMA3-1B-Router_16K_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 GEMMA3 Router 16K 訓練矩陣 (純淨架構 16K 版本 + 原生權重起步)...")
    ...
    final_path = os.path.join(SAVE_DIR, "final_gemma3_router_ac_16k.pth")
    torch.save(
        (
            model.state_dict()
