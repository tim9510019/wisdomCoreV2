# trainCPTAC_GEMMA3_1K.py — GEMMA 3 原始架構預訓練引擎 (原生 Gemma 3 權重起步)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/gemma3_cpt_checkpoints_1K_NV"
LOG_PATH = "~/gemma3_cpt_1k_NV_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/GEMMA3-1B-CPT_1KGT_NV"
...
# ==========================================
def main():
    print("\n🚀 啟動 GEMMA3 CPT 訓練矩陣 (純淨架構 1K 版本 + 原生權重起步)...")
    ...
    torch.save(model.state_dict() if not hasattr(model, 'module') else model.module.state_dict(), os.path.join(SAVE_DIR, "final_gemma3_cpt_1k.pth"))
