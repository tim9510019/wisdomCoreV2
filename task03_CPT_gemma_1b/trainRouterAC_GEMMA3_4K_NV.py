# trainRouterAC_GEMMA3_4K_NV.py — 物理隔離對齊終極版 (GEMMA3 架構 + NV 雙卡配置 + 4K 長度)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/gemma3_zerogate_ac_checkpoints_4K_NV"
LOG_PATH = "~/gemma3_zerogate_ac_4k_nv_log.csv"
BEST_2K_PATH = "~/gemma3_zerogate_ac_checkpoints_2K_NV/best_model.pth"

SAVE_DIR = os.path.expanduser(SAVE_DIR)
LOG_PATH = os.path.expanduser(LOG_PATH)
BEST_2K_PATH = os.path.expanduser(BEST_2K_PATH)
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/GEMMA3-1B-Router_4K_NV"
...
def main():
    print(
        "\n🚀 啟 নিরাপ GEMMA3 Router 4K 訓練矩陣 (純淨架構 4K 版本 + 原生權重起步)..."
    )
    ...
    final_path = os.path.join(SAVE_DIR, "final_gemma3_router_ac_4k.pth")
    torch.save(
        (
            model.state_dict()
