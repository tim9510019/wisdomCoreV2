# trainCPTAC_GEMMA3.py — GEMMA 3 原始架構預訓練引擎 (最小改動版)
import os
import sys
import csv
import time
...
SAVE_DIR = "~/gemma3_cpt_checkpoints_1KS_NV"
LOG_PATH = "~/gemma3_cpt_1kS_NV_log.csv"
...
# HuggingFace 自動上傳配置
REPO_ID = "tim9510019/GEMMA3-1B-CPT_GT_NV"
...
def main():
    ...
    torch.save(model.state_dict() if not hasattr(model, 'module') else model.module.state_dict(), os.path.join(SAVE_DIR, "final_gemma3_cpt.pth"))
