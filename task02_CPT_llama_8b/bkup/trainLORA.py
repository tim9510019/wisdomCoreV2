...
def main():
    ...
    # ----------------------------------------------------
    # 1. 自動匹配 AGIV2L 的可訓練路由參數總量
    # ----------------------------------------------------
    print("🔄 正在分析原 AGIV2L 的可訓練參數總量...")
    dummy_base = AGIV2L(vocab_size=len(tokenizer), D=4096, hidden_dim=14336, num_blocks=32)
    ...
    print(f"🤩 最佳 LoRA Rank (r) 為 {optimal_r} 以完美對標 AGIV2L 的負載")
    ...
    print(f"✅ LoRA 初始化完成，實際訓練參數: {final_params:,} (與目標差距: {final_params - target_params:,})")
